#!/bin/bash
############################
# description:主机信息每日巡检,当前脚本适用于CentOS/RedHat 6.X、7.X
# version：3.3.2
...
echo "   服务器型号: $(dmidecode | grep 'Product Name')"
echo "   系统序列号: $(dmidecode -s system-serial-number)"
echo " 主板的序列号: $(dmidecode |grep 'Serial Number')"
echo "     主板信息: $(dmidecode -t 2)"
echo "      OEM信息: $(dmidecode -t 11)"
